...
<div class="container py-4">
    ...
    <form method="POST" action="{{ route('admin.dokter.update', $dokter) }}">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="tgl_lahir" class="form-control" value="{{ old('tgl_lahir', $dokter->tgl_lahir ? $dokter->tgl_lahir->format('Y-m-d') : '') }}">
        ...
        <div class="mb-3">
            ...
            <select name="is_jaga" class="form-select">
                <option value="0" {{ old('is_jaga', $dokter->is_jaga) == '0' ? 'selected' : '' }}>Tidak</option>
                <option value="1" {{ old('is_jaga', $dokter->is_jaga) == '1' ? 'selected' : '' }}>Ya</option>
            </select>
