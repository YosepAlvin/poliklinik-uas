            ...
            <div class="card-body">
                <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6" id="poli-container" style="display: {{ old('role') === 'dokter' ? 'block' : 'none' }};">
                        ...
                        <div class="col-md-6" id="jaga-container" style="display: {{ old('role') === 'dokter' ? 'block' : 'none' }};">
