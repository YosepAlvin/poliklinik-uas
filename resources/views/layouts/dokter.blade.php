        ...
        <ul class="navbar-nav ms-auto align-items-center">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="{{ route('dokter.profile') }}"><i class="bi bi-person"></i> Profile</a></li>
                    <li><a class="dropdown-item" href="{{ route('dokter.dashboard') }}"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
